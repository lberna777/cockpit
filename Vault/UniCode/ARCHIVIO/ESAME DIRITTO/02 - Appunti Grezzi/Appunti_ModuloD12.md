...
Sapere cos'è e spiegare la logica dell'**AI act**, classificare un sistema di IA nel **livello di rischio corretto**, identificare gli **obblighi** di **fornitore e deplyer**, e descrivere le novità 2026


Il regolamento UE 2024/1689 è il **primo quadro giuridico sull'IA** al mondo, basato su tre **idee fondamentali:**
- Essere il primo quadro giuridico sull'IA a livello mondiale
- Promuovere un'IA affidabile in Europa
- Stabilire norme **basate sul rischio** per gli sviluppatori e gli operatori di IA

deve ancora entrare in vigore (pianamente applicabile 2 agosto 2026)

## §1 — Perché una Legge sull'IA?

Per garantire l'affidabilità ai cittadini europei. Alcuni sistemi presentano rischi che devono essere affrontati per prevenire ed evitare risultati indesiderati. Ad esempio, è importante comprendere i motivi che hanno condotto un sistema di IA a prendere una decisione o fare una previsione. qual'ora usati per recruitment per esempio potrebbe essere stato indebitamente svantaggiato nell'accesso all'università o in un'assunzione, oppure in ambito di previsioni, una valutazione o una diagnosi medica potrebbe essere errata.

Le basi che stabilisce sono:

- regole per l'immissione sul mercato, messa in servizio e uso dei sistemi di IA
- divieti di alcune pratiche di IA
- requisiti specifici per sistemi di IA ad alto rischio, e obblighi per gli operatori di essi
- regole di trasparenza armonizzate
- (questa è uguale alla prima dai)
- regole per il monitoraggio del mercato, vigilanza del mercato governance ed esecuzione (spiega cosa significano queste cose)
- misure a sostegno dell'innovazione, attenzione alle PMI (cosa sono?), comprese le startup
...
si tratta di un **sistema automatizzato** che funziona con livelli di **autonomia variabile** (in che senso può presentare adattabilità dopo la diffusione?) e che deduce da un input per generare un output.ù

> Un sistema che si limita a eseguire regole fisse scritte da un programmatore non è un sistema di IA ai sensi della legge.

Chi è il **fornitore?**

È una persona **fisica o giuridica**, un autorità pubblica, un'agenzia o altro organismo che **sviluppa** un sistema di IA o un modello di IA per finalità generali **o** che **fa sviluppare** un sistema di IA e **immette tale sistema o modello sul mercato** o **mette in servizio il sistema di IA con il proprio nome o marchio**, a titolo oneroso o gratuito.

Il fornitore è chi mette il proprio nome/marchio sul sistema — che lo abbia sviluppato direttamente o commissionato.

chi è il **deployer?**

Una persona fisica o giuridica, un'autorità pubblica, un'agenzia o un altro organismo che **utilizza un sistema di IA sotto la propria autorità** nel corso di attività professionali
...
fornisci esempi tangibili e una spiegazione concisa ma completa di tutte queste pratiche
...
I problemi più preoccupanti riguardano scelte che incidono sulla vita di un individuo, non solo sanitarie, o anche attività di selezione con bias che influiscono quando non dovrebbero esistere

I sistemi di IA ad alto rischio sono soggetti ad obblighi rigorosi prima di poter essere immessi sul mercato come:

- Adeguati **sistemi di valutazione e mitigazione dei rischi**
- alta qualità della serie di dati che alimentano il sistema (per evitare risultati discriminatori)
- registrazione e tracciabilità garantita dei risultati
- documentazione dettagliata pronta ad essere rilasciata alle autorità riguardo al sistema e al suo scopo
- informazioni chiare e adeguate per l'operatore
- adeguate misure di sorveglianza umana
- elevato livello di robustezza sicurezza e accuratezza dell'architettura 

## §7 — Rischio Limitato: Obblighi di Trasparenza

**sono obblighi di divulgazione specifici** per garantire che gli esseri umani siano **informati** quando necessario per preservare la fiducia. necessari per forme di applicazione di sistemi AI a rischio limitato:

- Nell'utilizzo dei **chatbot**, gli utenti devono essere resi consapevoli di star interagendo con una macchina
- Va garantita la identificabilità dei contenuti generati dall'IA
- alcuni contenuti generati dall'IA devono essere etichettati in modo **chiaro e visibile** come deep fake e testi pubblicati allo scopo di informare il pubblico su questioni di interesse pubblico.
...
Obblighi aggiuntivi: **sicurezza**, **valutazione avversariale**, **segnalazione incidenti all'AI Office**. (di che tipo di modelli si tratta? atti a cosa?)
...
La **Commissione europea**, tramite l'**AI Office**, ha **competenza esclusiva** sui fornitori GPAI; i poteri sanzionatori diventano pienamente operativi il **2 agosto 2026**. (cosa significa competenza esclusiva?)

## §10 — Sanzioni

Sono divise in **tre fasce** basate sul tipo di violazione eseguito:
...
**Per PMI e start-up**: si applica il minore tra la soglia fissa e la percentuale sul fatturato (regime più favorevole). [fonte: PDF]

**Sanzioni non pecuniarie**: ritiro del sistema dal mercato, blocco immediato dell'utilizzo, cancellazione dai database. **Le sanzioni sono simili per struttura a quelle del GDPR** e si **cumulano** con esse (questo perchè sempre di dati parliamo no?). [fonte: PDF]
...
Il 19 novembre 2025 la Commissione ha proposto il "Digital Omnibus sull'IA", pacchetto di modifiche mirate all'AI Act.
...
schematizza le violazioni dei casi pratici, in base a tipo di violazione, tipo di sanzione e rilevanza rispetto all'AI act
