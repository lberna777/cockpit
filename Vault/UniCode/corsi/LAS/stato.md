# LAS — Laboratorio di Amministrazione di Sistemi T · stato archiviato

> Archivio di `stato/corrente.md` al momento del cambio di esame (`CLAUDE.md` §3, regola 3).
> Il contenuto qui sotto è quello prodotto fino alla sessione 52 del **15/07/2026**, nella
> preparazione poi interrotta a metà sessione estiva 2026. Trasferito senza modifiche il
> **14/09/2026**: i riferimenti interni a `ESAMI SCELTI.md`, `stato/percorso.md` e
> `stato/log_sessioni.md` appartengono alla struttura precedente e vanno riletti come tali.
>
> Quando `LAS` tornerà in fase attiva, questo stato si riprende da qui.
